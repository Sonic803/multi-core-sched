...
\begin{itemize}
    ...
    \item \cboh{No delay tra i i vari componenti (scheduler, processgenerator, Cpu)}
    \item \cboh{Sorting algorithm zero delay}
    \item \cboh{Non c'è overhead nelle transizioni}
    \item \cboh{IID RV}
    \item \cboh{operazioni I/O indipendenti (non interferiscono)}
\end{itemize}
